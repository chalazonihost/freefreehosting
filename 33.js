...
document.getElementById("message").innerHTML = "Τα τέλη κυκλοφορίας που θα πληρώσετε για το 2015 ανέρχονται σε " + finalpay + " euro.";
}
</script>

<h1>Υπολογίστε τα τέλη κυκλοφορίας</h1>

  <label>Αποκτήσατε το ΙΧ σας </label>
<select name="date_of_purchase" onchange="leaveChange()" id="date_of_purchase">
<option value="0">Επιλέξτε</option>
<option value="af">Μετά τον Νοέμβριο του 2010</option>
<option value="be">Πριν τον Νοέμβριο του 2010</option>
</select>	

<div style="display:none" id="af">
  <label>Οι ρύποι CO<sub>2</sub> που εκπέμπει το ΙΧ σύμφωνα με την άδεια κυκλοφορίας είναι </label>
  <input type="text" name="rypoi" value="" id="t1" />γρ/χλμ
  <input type="button" value="Υπολογισμός" onClick="findteli();" />
</div>

<div style="display:none" id="be">
  <label>Ο κινητήρα του οχήματος (αυτοκίνητο - μοτοσυκλέτα) είναι </label>
  <input type="text" name="kibika" value="" id="t2" />κυβικά εκατοστά (όπως αναγράφεται στην άδεια κυκλοφορίας)
  <input type="button" value="Υπολογισμός" onClick="findteli();" /><br />chalazoni.blogspot
</div>
